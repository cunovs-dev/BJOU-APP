...
class FeedBack extends Component {
  ...
  render () {
    const { name, courseid, cmid = '' } = this.props.location.query,
      { data: { intro, completedcount, canviewanalysis, itemscount, itemsdata, anonymous, cansubmit, isopen, coursemodule, name: feedName = '', completionsubmit, id, isalreadysubmitted, axisDataKey = '数量', _useScriptFunc = false }, selectIndex = 0 } = this.props.feedback,
...
export default connect(({ loading, feedback, app }) => ({
